...
const Banner = () => {
  ...
  return (
    <div className="relative h-[60vh] md:h-[50vh] lg:h-[60vh]">
      ...
      />
      <section className="absolute bottom-0 left-0 w-full h-auto backdrop-blur-xs bg-gradient-to-t from-black to-black/10 py-5 xl:px-40 lg:px-20 md:px-20 sm:px-5 xs:px-5">
        <Title
          loaded={loaded}
