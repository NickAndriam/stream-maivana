...
export default function BottomNavbar() {
  ...
  return (
    <div
      className="fixed bottom-5 z-10 left-1/2 -translate-x-1/2 w-auto h-16 bg-background/50 backdrop-blur-sm  flex items-center justify-evenly shadow-md gap-10 rounded-xl border-2 border-foreground/20
    px-5 py-2"
    >
